...
const DeepsViewDoublePane: FC<Props> = (props: Props) => {
    ...
    const [containerSizes, setContainerSizes] = React.useState<Array<any>>([props.initRatio ? props.initRatio[0] * parentSizeWithoutDividers : equalSize, props.initRatio ? props.initRatio[1] * parentSizeWithoutDividers : equalSize]);
