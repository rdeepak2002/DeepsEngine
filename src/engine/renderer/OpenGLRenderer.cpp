...
void OpenGLRenderer::update() {
    ...
    // set light color
    glm::vec3 lightColor;
    lightColor.x = sin(Application::getInstance().getCurrentTime() * 2.0f);
    lightColor.y = sin(Application::getInstance().getCurrentTime() * 0.7f);
    lightColor.z = sin(Application::getInstance().getCurrentTime() * 1.3f);
